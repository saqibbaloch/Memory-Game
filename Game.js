	...
	console.log("in submit button function");
  	...
  	if(playerName == '' || playerEmail == ''){
  		if(playerName == ''){
  		 ...
  		 //receiving rankings from the server
  		
  		 $.getJSON('ranking.php',function(jsonData){
	
    		if(jsonData[0] == playerName)
  				alert("congratulations! You are the heighest scorer");
 	    	else
  			alert("Highest scorer is "+jsonData[0]);
  		});
